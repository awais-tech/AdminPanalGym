...
{/* 
      <Divider /> */}
      {/* <List>
        {['My Services'].map((text, index) => (
          <ListItem button key={text} onClick={() => navigate('/allServices')}>
            <ListItemIcon style={{color:"white"}}>
              <RestaurantMenuIcon />
            </ListItemIcon>
            <ListItemText primary={text} style={{color:"white"}}/>
      ...
      {/* <List>
        {['My Booking'].map((text, index) => (
          <ListItem button key={text} onClick={() => navigate('/AdminBooking')}>
            <ListItemIcon style={{color:"white"}}>
              <RestaurantMenuIcon />
            </ListItemIcon>
            <ListItemText primary={text} style={{color:"white"}}/>
      ...
      <List>
        {['Log Out'].map((text, index) => (
          <ListItem button key={text} onClick={() => navigate('/')} style={{color:"white"}}>
            <ListItemIcon style={{color:"white"}}>
              <LogoutIcon />
            </ListItemIcon>
  ...
  return (
    <Box sx={{ display: 'flex', backgroundColor: '#EAF9FB' }}>
      ...
      >
        <Toolbar style={{ backgroundColor: '#E2C657' }}>
          <IconButton
            color="inherit"
